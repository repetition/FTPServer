...
public class Config {
    ...
    public static String  UserConfig= "ftpserver.user.admin.userpassword=admin\r\n"+
            "ftpserver.user.admin.homedirectory=/sdcard/\r\n"+
            "ftpserver.user.admin.enableflag=true\r\n"+
            "ftpserver.user.admin.anon-enabled=true\r\n"+
            ...
            "ftpserver.user.anonymous.homedirectory=/sdcard/\r\n"+
